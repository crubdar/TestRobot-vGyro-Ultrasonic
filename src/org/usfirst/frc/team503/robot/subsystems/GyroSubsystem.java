...
public class GyroSubsystem extends Subsystem implements PIDOutput{
    ...
    public GyroSubsystem() {
	    ...
	    turnController = new PIDController(Robot.bot.GYRO_P, Robot.bot.GYRO_I, Robot.bot.GYRO_D, Robot.bot.GYRO_F, gyro, this);
	    turnController.setInputRange(-180.0,  180.0);
	    turnController.setOutputRange(-0.6,0.6); //was 0.6
    ...
    public void sendDashboardData(){
        ...
        SmartDashboard.putNumber("PID Output",               RobotMap.rotateToAngleRate);
    }
	...
	public void initDefaultCommand() {
	    ...
	    //setDefaultCommand(new MySpecialCom
	}
}
